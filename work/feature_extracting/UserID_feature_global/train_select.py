...
x = np.load('../Basic_feature/train_basic_feature.npy')
print(x.shape)
...
test_x = np.load('../Basic_feature/test_basic_feature.npy')
print(test_x.shape)
...
select_index = scores[:50]['index'].values
...
print('save...')
np.save('./train_feat50.npy', x[:, select_index])
# np.save('./test_feat50.npy', test_x[:, select_index])